...
1. **Open in VS Code:**  
   - Install the [Remote - Containers extension](https://code.visualstudio.com/docs/remote/containers).  
...
✨ Ready to contribute? Browse the [Data Nadhi repositories](https://github.com/search?q=topic%3Adata-nadhi+org%3AData-ARENA-Space&type=Repositories) and pick a repo to start with!
